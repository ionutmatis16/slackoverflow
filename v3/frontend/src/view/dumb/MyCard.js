...
const MyCard = ({
                    ...
                    onChangeNewAnswer, onEditSubmit, questionId
                }) => (
    <div>
        {
            qAType === "question" ?
                ...
                (
                    questionAnswer.userName === sOUsername ?
                        <div>
                            <button onClick={() => onDeleteAnswer(questionAnswer.id, questionId)}
                ...
                questionAnswer.editButtonPressed ?
                    <div className="input-group mb-3">
                        ...
                        <div className="input-group-append">
                            <button onClick={() => onEditSubmit(questionAnswer.id, questionId)}

...
public class VoteServiceUnitTests {
    ...
    public void testUpvote() {
        ...
        VoteService voteService = new VoteService(factory, eventPublisher);

        voteService.voteQuestion(0, new QuestionVoteDTO(0, 1, true));
        voteService.voteQuestion(0, new QuestionVoteDTO(1, 1, true));
    }
    ...
    public void testMultipleVotes() {
        ...
        voteService.voteAnswer(1, 2, new AnswerVoteDTO(0, 2, true));
        voteService.voteAnswer(1, 1, new AnswerVoteDTO(0, 2, false));
        voteService.voteAnswer(1, 1, new AnswerVoteDTO(0, 2, true));
        voteService.voteAnswer(1, 1, new AnswerVoteDTO(0, 2, false));
